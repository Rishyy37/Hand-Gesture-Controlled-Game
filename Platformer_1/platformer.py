...
# load images
sun_img = pygame.image.load(r'img\sun.png')
...
class Player():
    ...
    def update(self, game_over,data):
        direction = data[0]
        dx = 0
        dy = 0
        walk_cooldown = 5
        ...
        if game_over == 0:
            ...
            if direction == 5 and self.jumped == False and self.in_air == False:
                jump_fx.play()
                self.vel_y = -15
                self.jumped = True
    ...
    def reset(self, x, y):
        ...
        for num in range(1, 5):
            img_right = pygame.image.load('img/red.png')
            img_right = pygame.transform.scale(img_right, (56, 56))
